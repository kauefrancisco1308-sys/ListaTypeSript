...
document.getElementById('q5poo')?.addEventListener('click',q5poo)
document.getElementById('q6poo')?.addEventListener('click',q6poo)
document.getElementById('q7poo')?.addEventListener('click',q7poo)
document.getElementById('q8poo')?.addEventListener('click',q8poo)
document.getElementById('q9poo')?.addEventListener('click',q9poo)
document.getElementById('q10poo')?.addEventListener('click',q10poo)
document.getElementById('q11poo')?.addEventListener('click',q11poo)
document.getElementById('q12poo')?.addEventListener('click',q12poo)
