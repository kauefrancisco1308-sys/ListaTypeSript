...
export function q21poo(): void {
    abstract class Floramp{
        título:string
        coordenador:string
        protected _notaAvaliativa:string
        constructor(titulo:string, coordenador:string, notaAvaliativa:string){
        ...
        set notaAvaliativa(notaAvaliativa:string){
                this._notaAvaliativa=notaAvaliativa
            }
        }
